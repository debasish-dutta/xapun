...
const Team = () => {
  ...
  <section class="mb-20">
    <div
      ...
      style={bgImg} >
      <div
        class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/[.75]">
        <div class="flex justify-center items-center h-full">
          <div class="text-center text-white px-6 md:px-12">
            <h1 class="text-l md:text-xl xl:text-2xl font-bold tracking-tight mb-12">
            <span>XOPON-Bastawayita Korar Proyakh<br />( Dream- Trying to make it into Reality)</span> <br /> It is basically a dream of a bunch of people wanting to do something for the well being of the society united for a noble cause.
            </h1>
          </div>
        </div>
      </div>
  ...
  <section class="mb-32 text-center">
    <h2 class="text-3xl text-blue-600 font-bold mb-32">Meet our <i class="">members</i></h2>
    <div className='grid gap-y-24 lg:gap-y-36 md:grid-row-3'>
    ...
    <div class="grid gap-x-6 lg:gap-x-12 md:grid-cols-3">
        ...
        <div class="rounded-lg shadow-lg h-full block bg-white">
          <div class="flex justify-center">
            <div class="flex justify-center" style={{marginTop: `-75px`}}>
              <img src="https://mdbootstrap.com/img/new/avatars/6.jpg" class="w-[150px] rounded-full mx-auto shadow-lg" alt=""/>
            </div>
          </div>
          <div class="p-6">
            <h5 class="text-lg font-bold mb-4">Marta Smith</h5>
            <p class="text-gray-500 mb-6">Frontend Developer</p>
      ...
      <div class="mb-24 md:mb-0">
        <div class="rounded-lg shadow-lg h-full block bg-white">
          <div class="flex justify-center">
            <div class="flex justify-center" style={{marginTop: `-75px`}}>
              <img src="https://mdbootstrap.com/img/new/avatars/8.jpg" class="w-[150px] rounded-full mx-auto shadow-lg" alt="" />
            </div>
          </div>
          <div class="p-6">
            <h5 class="text-lg font-bold mb-4">Darren Randolph</h5>
            <p class="text-gray-500 mb-6">Marketing expert</p>
            <ul class="list-inside flex mx-auto justify-center">
              <a href="#!" class="px-2">
      ...
      <div class="">
        <div class="rounded-lg shadow-lg h-full block bg-white">
          <div class="flex justify-center">
            <div class="flex justify-center" style={{marginTop: `-75px`}}>
              <img src="https://mdbootstrap.com/img/new/avatars/15.jpg" class="w-[150px] rounded-full mx-auto shadow-lg" alt="" />
            </div>
          </div>
          <div class="p-6">
            <h5 class="text-lg font-bold mb-4">Ayat Black</h5>
            <p class="text-gray-500 mb-6">Web designer</p>
            <ul class="list-inside flex mx-auto justify-center">
              <a href="#!" class="px-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 text-blue-600">
                  <path fill="currentColor"
  ...
  <section class="mb-32 text-center lg:text-left">
    <h2 class="text-3xl text-blue-600 font-bold mb-12 text-center">
      Meet the <i>developers</i>
    </h2>
        ...
        <div class="relative block rounded-lg shadow-lg bg-white p-6">
          <div class="lg:flex flex-row items-center">
            ...
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-7/12">
              <h5 class="text-lg font-bold mb-2">Darren Randolph</h5>
      ...
      <div class="mb-6 lg:mb-0">
        <div class="relative block rounded-lg shadow-lg bg-white p-6">
          <div class="lg:flex flex-row items-center">
            ...
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-7/12">
              <h5 class="text-lg font-bold mb-2">Maliha Welch</h5>
