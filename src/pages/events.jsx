...
const Events = () => {
  return (
    <div className='h-full px-6 sm:px-4 py-2 bg-white dark:bg-gray-800'>

      

<section class="mb-32 text-gray-800 dark:text-white text-center md:text-left">
...
<div class="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
  <div class="mb-6 md:mb-0">
    <div
      ...
      <a href="/">
        <div class="bg-[rgba(251, 251, 251, 0.2)] absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed opacity-0 hover:opacity-100 transition duration-300 ease-in-out"
          ></div>
      </a>
    </div>
  </div>
